...
export function MobileNavigation() {
  ...
  return <>
    ...
    {open && <div className="mobile-menu" id="mobile-menu" role="dialog" aria-modal="true" aria-label="Main menu">
      ...
      <div className="mobile-menu__actions"><Button href={siteConfig.actions.getMova}>Get Mova</Button><Button href={siteConfig.actions.signIn} variant="secondary">Sign in</Button></div>
    </div>}
  </>;
}
